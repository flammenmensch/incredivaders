	    ...
	    return function (_SuperClass) {
	      ...
	      _createClass(_class, [{
	        ...
	        value: function reset() {
	          _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), "reset", this).apply(this, arguments);
...
/***/ function(module, exports) {
	...
	var BaseLaunchStrategy = function BaseLaunchStrategy(owner) {
	  _classCallCheck(this, BaseLaunchStrategy);

	  this.__owner = owner;
	};

	exports.default = BaseLaunchStrategy;
...
/***/ function(module, exports) {
	...
	var SoundGroup = function () {
	  ...
	  _createClass(SoundGroup, [{
	    key: "play",
	    value: function play() {
	      var sfx = this.__game.rnd.pick(this.__sfx);
	      sfx.play();
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	var Enemies = function (_Phaser$Group) {
	  ...
	  function Enemies(game, enemyClass, enemySpriteKey, enemyLauncherClass) {
	    var enemyCount = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 5;
	    ...
	    _this.enemyLauncher = new enemyLauncherClass(_this);
	    _this.enemyLauncher.scheduleLaunch();
	    return _this;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SoundGroup = __webpack_require__(89);
	...
	var Explosions = function (_Phaser$Group) {
	  ...
	  function Explosions(game, animations, sounds) {
	    _classCallCheck(this, Explosions);

	    var _this = _possibleConstructorReturn(this, (Explosions.__proto__ || Object.getPrototypeOf(Explosions)).call(this, game));

	    _this.explosionSfx = new _SoundGroup2.default(game, sounds);
	    _this.enableBody = true;
	    _this.physicsBodyType = Phaser.Physics.ARCADE;
	    animations.forEach(function (animation) {
	      return _this.createMultiple(10, animation);
	    });
	  ...
	  _createClass(Explosions, [{
	    ...
	    value: function explode(target) {
	      var explosion = this.getRandomNotExists();
	    ...
	    key: 'getRandomNotExists',
	    value: function getRandomNotExists(startIndex, endIndex) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _simpleMovementMixin = __webpack_require__(87);

	var _simpleMovementMixin2 = _interopRequireDefault(_simpleMovementMixin);

	var _mix = __webpack_require__(86);
	...
	var PowerUps = function (_Phaser$Group) {
	  _inherits(PowerUps, _Phaser$Group);
	  ...
	  function PowerUps(game) {
	    ...
	    var _this = _possibleConstructorReturn(this, (PowerUps.__proto__ || Object.getPrototypeOf(PowerUps)).call(this, game));

	    _this.enableBody = true;
	    _this.classType = (0, _mix2.default)(PowerUp).with((0, _simpleMovementMixin2.default)(200));
	    _this.physicsBodyType = Phaser.Physics.ARCADE;

	    sprites.forEach(function (sprite) {
	      _this.createMultiple(sprite.quantity, sprite.key);
	    });
	    return _this;
	  }
	  ...
	  _createClass(PowerUps, [{
	    key: 'addPowerup',
	    value: function addPowerup(x, y) {
	      var powerUp = this.getRandomNotExists();
	...
	var PowerUp = function (_Phaser$Sprite) {
	  ...
	  function PowerUp() {
	    ...
	    var _this2 = _possibleConstructorReturn(this, (PowerUp.__proto__ || Object.getPrototypeOf(PowerUp)).apply(this, arguments));

	    _this2.__sfx = new _SoundGroup2.default(_this2.game, ['pickup1', 'pickup2', 'pickup3'], false);
	    return _this2;
	  }

	  _createClass(PowerUp, [{
	    key: 'applyTo',
	    value: function applyTo(entity) {
	      this.__sfx.play();
	      switch (this.key) {
	        case 'powerUpShield':
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoadState = __webpack_require__(140);

	var _LoadState2 = _interopRequireDefault(_LoadState);

	var _PlayState = __webpack_require__(141);
	...
	var Game = function (_Phaser$Game) {
	  ...
	  function Game() {
	    ...
	    return _this = _possibleConstructorReturn(this, (Game.__proto__ || Object.getPrototypeOf(Game)).call(this, 800, 600, Phaser.AUTO, 'game', {
...
/***/ function(module, exports) {
	...
	exports.default = function (position) {
	  var accelerationFactor = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 10;
...
/***/ function(module, exports) {
	...
	exports.default = function () {
	  var acceleration = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 600;
	  var maxSpeed = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 400;
	  var drag = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 400;
	  var padding = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 32;
	    ...
	    return function (_SuperClass) {
	      ...
	      _createClass(_class, [{
	        ...
	        value: function withinFireBounds() {
	          return this.x > 0 && this.x < this.game.width && this.y > 100 && this.y < this.game.height * .5;
	        }
	      }]);
...
/***/ function(module, exports) {
	...
	exports.default = function () {
	  var maxSpeed = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 300;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _simpleRotationMixin = __webpack_require__(135);

	var _simpleRotationMixin2 = _interopRequireDefault(_simpleRotationMixin);
	...
	var mixins = {
	  ...
	  simpleMovementFactory: _simpleMovementMixin2.default,
	  simpleRotationFactory: _simpleRotationMixin2.default
	};
...
/***/ function(module, exports) {
	...
	exports.default = function () {
	  var key = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : Phaser.Keyboard.SPACEBAR;
...
/***/ function(module, exports) {
	...
	exports.default = function () {
	  var speed = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 300;
	  var drag = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 300;
...
/***/ function(module, exports) {
	...
	exports.default = function () {
	  var factor = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 2;
	  var ccv = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
...
/***/ function(module, exports) {
	...
	exports.default = function () {
	  var verticalSpeed = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 180;
	  var frequency = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 100;
	  var spread = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 60;
...
/***/ function(module, exports) {
	...
	var Enemy = function (_Phaser$Sprite) {
	  ...
	  function Enemy(game, x, y, key) {
	    ...
	    var _this = _possibleConstructorReturn(this, (Enemy.__proto__ || Object.getPrototypeOf(Enemy)).call(this, game, x, y, key));
	  ...
	  _createClass(Enemy, [{
	    key: "reset",
	    value: function reset() {
	      _get(Enemy.prototype.__proto__ || Object.getPrototypeOf(Enemy.prototype), "reset", this).apply(this, arguments);
	      this.health = 25;
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	var StarField = function (_Phaser$TileSprite) {
	  ...
	  function StarField(game) {
	    ...
	    return _possibleConstructorReturn(this, (StarField.__proto__ || Object.getPrototypeOf(StarField)).call(this, game, 0, 0, game.width, game.height, 'space'));
	  }

	  _createClass(StarField, [{
	    key: 'update',
	    value: function update() {
	      _get(StarField.prototype.__proto__ || Object.getPrototypeOf(StarField.prototype), 'update', this).call(this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _weaponFactory = __webpack_require__(145);
	...
	var _mixins = __webpack_require__(131);

	var _mixins2 = _interopRequireDefault(_mixins);

	var _randomLaunchStrategy = __webpack_require__(143);

	var _randomLaunchStrategy2 = _interopRequireDefault(_randomLaunchStrategy);

	var _queueLaunchStrategy = __webpack_require__(142);
	...
	var createUfo = function createUfo(target) {
	  return (0, _mix2.default)(_Enemy2.default).with(_mixins2.default.randomMovementMixinFactory(), _mixins2.default.simpleRotationFactory());
	};

	var createMeteor = function createMeteor(rotation, speed) {
	  return (0, _mix2.default)(_Enemy2.default).with(_mixins2.default.simpleRotationFactory(rotation, Math.random() >= 0.5), _mixins2.default.simpleMovementFactory(speed));
	};
	...
	var PlayState = function (_Phaser$State) {
	  ...
	  _createClass(PlayState, [{
	    ...
	    value: function create() {
	      ...
	      this.enemies = [this.game.add.existing(new _Enemies2.default(this.game, createBlackEnemy(), 'enemyBlack', (0, _queueLaunchStrategy2.default)(750, 1500, 50), 10)), this.game.add.existing(new _Enemies2.default(this.game, createRedEnemy(this.player), 'enemyRed', (0, _randomLaunchStrategy2.default)(3000, 6000), 5)), this.game.add.existing(new _Enemies2.default(this.game, createBlueEnemy(), 'enemyBlue', (0, _randomLaunchStrategy2.default)(5000, 7500), 5)), this.game.add.existing(new _Enemies2.default(this.game, createUfo(), 'ufoRed', (0, _randomLaunchStrategy2.default)(15000, 17500), 2))];
	      this.meteors = [this.game.add.existing(new _Enemies2.default(this.game, createMeteor(3, 300), 'meteorMed1', (0, _randomLaunchStrategy2.default)(8000, 16000), 5)), this.game.add.existing(new _Enemies2.default(this.game, createMeteor(3, 400), 'meteorTiny1', (0, _randomLaunchStrategy2.default)(5000, 10000), 5)), this.game.add.existing(new _Enemies2.default(this.game, createMeteor(3, 400), 'meteorTiny2', (0, _randomLaunchStrategy2.default)(5000, 10000), 5))];
	      this.powerups = this.game.add.existing(new _PowerUps2.default(this.game, [{ quantity: 3, key: 'powerUpBolt' }, { quantity: 3, key: 'powerUpStar' }, { quantity: 3, key: 'powerUpShield' }]));
	      this.explosions = this.game.add.existing(new _Explosions2.default(this.game, ['explosion1', 'explosion2'], ['explosionSfx1', 'explosionSfx2', 'explosionSfx3']));
	    ...
	    value: function update() {
	      ...
	      this.game.physics.arcade.overlap([this.player].concat(_toConsumableArray(this.enemies)), this.meteors, this.collideMeteors, null, this);
	    ...
	    key: 'collideMeteors',
	    value: function collideMeteors(entity) {
	    ...
	    key: 'hitMeteor',
	    value: function hitMeteor(bullet) {
	      bullet.kill();
	    }
	  }, {
	    key: 'collectPowerUp',
	    value: function collectPowerUp(player, powerup) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  var minSpacing = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 2500;
	  var maxSpacing = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 4000;
	  var verticalSpacing = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 70;
	  var numEnemiesInWave = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 10;

	  return function (_BaseLaunchStrategy) {
	    _inherits(QueueLaunchStrategy, _BaseLaunchStrategy);

	    function QueueLaunchStrategy() {
	      _classCallCheck(this, QueueLaunchStrategy);

	      return _possibleConstructorReturn(this, (QueueLaunchStrategy.__proto__ || Object.getPrototypeOf(QueueLaunchStrategy)).apply(this, arguments));
	    }

	    _createClass(QueueLaunchStrategy, [{
	      key: 'scheduleLaunch',
	      value: function scheduleLaunch() {
	        this.__owner.game.time.events.add(this.__owner.game.rnd.integerInRange(minSpacing, maxSpacing), this.__launch.bind(this, this.__owner));
	      }
	    }, {
	      key: '__launch',
	      value: function __launch() {
	        var enemy = void 0;
	  ...
	  }(_BaseLaunchStrategy3.default);
	};

	var _BaseLaunchStrategy2 = __webpack_require__(88);

	var _BaseLaunchStrategy3 = _interopRequireDefault(_BaseLaunchStrategy2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (minSpacing, maxSpacing) {
	  return function (_BaseLaunchStrategy) {
	    _inherits(RandomLaunchStrategy, _BaseLaunchStrategy);

	    function RandomLaunchStrategy() {
	      _classCallCheck(this, RandomLaunchStrategy);

	      return _possibleConstructorReturn(this, (RandomLaunchStrategy.__proto__ || Object.getPrototypeOf(RandomLaunchStrategy)).apply(this, arguments));
	    }

	    _createClass(RandomLaunchStrategy, [{
	      key: 'scheduleLaunch',
	      value: function scheduleLaunch() {
	        this.__owner.game.time.events.add(this.__owner.game.rnd.integerInRange(minSpacing, maxSpacing), this.__launch.bind(this));
	      }
	    }, {
	      key: '__launch',
	      value: function __launch() {
	        var enemy = this.__owner.getFirstExists(false);
	        if (enemy) {
	...
	exports.default = function (target) {
	  return function (_Phaser$Bullet) {
	    ...
	    function HomingMissile(game, x, y) {
	      ...
	      var _this = _possibleConstructorReturn(this, (HomingMissile.__proto__ || Object.getPrototypeOf(HomingMissile)).call(this, game, x, y, 'rocket'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _homingMissileFactory = __webpack_require__(144);
